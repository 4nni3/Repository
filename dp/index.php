...
<body>
  <div class="container">
    ...
    <div>
      ...
      <p><a href="https://twitter.com/4nni3_?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @4nni3_</a>
    ...
    <div class="info">
      ...
      <div>
        <p class="lbl">PackageID</p><span><?php echo $package; ?></span>
      </div>


      <div>
        <p class="lbl">Version</p><span><?php echo $version; ?></span>
      </div>


      <div>
        <p class="lbl">Author</p><span><?php echo $info['author']; ?></span>
      </div>

      <div>
        <p class="lbl">Section</p><span><?php echo $info['section']; ?></span>
      </div>


      <?php if ($compatible != -1) : ?>
        <div>
          <p class="lbl">Support</p><span id="support"><?php echo 'iOS ' . toFixed1($info['support_min']) . ' - ' . toFixed1($info['support_max']); ?></span>
        </div>
      <?php endif; ?>
